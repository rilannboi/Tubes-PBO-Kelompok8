...
echo "Bahan-bahan : ";
echo "--------------";
echo "1. 1/4 buah semangka, bentuk bulat";
echo "2. 1/3 buah melon, bentuk bulat";
echo "3. 1 buah apel, potong kotak";
echo "4. 10 buah stroberi, iris-iris";
echo "5. 5 biji buah nangka, potong kotak";
echo "6. 1/2 buah nanas";
echo "7. 1 kaleng leci";

//ella
echo "8. 2 sdm biji selasih";
echo "9. 1 liter susu cair full cream";
